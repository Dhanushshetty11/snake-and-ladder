...
document.getElementById("out").innerHTML += `
    <div id='pawnContainer'>
        <div id='pawn1_out' class='pawn'><img src='pown.jpg' class='img'></div>
...
var updatePawnPosition = function(pawn, currentPosition, newPosition) {
    ...
    newBox.innerHTML = "<img id='" + pawn + "' class='img' src='" + (pawn === 'pawn1' ? 'pown.jpg' : 'pawn2.png') + "'></img>";
}

var highlightPawn = function() {
    var pawn1Right = document.getElementById("pawn1_side"); 
    var pawn2Right = document.getElementById("pawn2_side"); 

    if (turn === 1) {
        pawn1Right.style.border = "5px solid yellow"; 
        pawn2Right.style.border = "none"; 
    } else {
        pawn1Right.style.border = "none";
        pawn2Right.style.border = "5px solid yellow"; 
    }
};
